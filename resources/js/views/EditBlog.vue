<template>
  <div class="container">
    <h1 class="title has-text-centered mt-3">Update Your blog</h1>
    ...
    <section>
      ...
      >
        <b-input type="text" v-model="title.text"> </b-input>
      </b-field>
      ...
      >
        <b-input type="textarea" v-model="details.text"></b-input>
      </b-field>
      ...
      <b-field label="Category">
        <b-select placeholder="Select a character" v-model="category.text">
      ...
      <b-field position="is-centered">
        ...
        <b-button type="is-primary" :loading="isLoading" @click="updateBlog"
          >Edit</b-button
        >
      </b-field>
    </section>
...
export default {
  ...
  methods: {
    async fillBlogDetails() {
      ...
      this.details.text = response.data.details;
      this.category.text = response.data.category;
    },
    ...
    async updateBlog() {
      ...
      if (this.img.file.length > 0) {
        formData.append("img", this.img.file);
      }

      formData.append("blog_id", this.blogId);
      ...
      let response = await api.updateBlog(formData);
